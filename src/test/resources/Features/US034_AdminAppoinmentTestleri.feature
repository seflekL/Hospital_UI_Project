...
Feature: Bir yönetici (admin) olarak randevulari yönetmek icin dashboard sidebar'da bir sayfanin olmasini istiyorum.
  ...
  @regression
  Scenario: Sidebar dogrulama testi
  ...
  Scenario: Appointment ogesinin gorunurluğunu ve islevselligini  test etme
  ...
  Scenario:Appoinment sayfasi Patient Name, Appointment No, Appointment Date, Phone, Gender, Doctor, Source, Priorty, Fees, Status basliklari gorunurluk testi
    Given Sidbarda "Appoinment" a tiklar
  ...
  Scenario:Patient Name liste basligi uzerinden siralama yapma testi
    Given Sidbarda "Appoinment" a tiklar
  ...
  Scenario:Search Box gorunurlugu ve islevselligi testi
    Given Sidbarda "Appoinment" a tiklar
  ...
  Scenario:Doktor wise butonu gorunurlugu ve aktifligi testi
    Given Sidbarda "Appoinment" a tiklar
  ...
  Scenario:Doktor ve Date secilerek filtreleme testi
    Given Sidbarda "Appoinment" a tiklar
    Then "Doctor Wise" butonuna tiklar
  ...
  Scenario:Queue butonu gorunurlugu ve aktifligi testi
  ...
  Scenario:Doktor dogrulama testi
    Given Sidbarda "Appoinment" a tiklar
    Then Queue butonuna tiklar
    And Doktor olarak Amit Singh (9009) secer
