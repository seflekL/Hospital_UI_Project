@smoke
Feature:Bir kullanici olarak hastaneye ait bilgilere kolay erisim icin
  ...
  Background:
    ...
    When Sayfayı kaydır
@regression1
  Scenario:Insurance Plans,Pediatric Services, Lab Testing board'larının görünür olması testi
  ...
  @regression1
  Scenario:Insurance Plans,Pediatric Services, Lab Testing board'ları altındaki read more butonunun
